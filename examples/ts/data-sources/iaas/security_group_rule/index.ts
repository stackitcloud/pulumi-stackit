...
export const example = stackit.getSecurityGroupRuleOutput({
    ...
    securityGroupRuleId: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",    // Replace with your actual security group rule ID
});
