...
// The resource region. If not defined, the provider region is used.
func (o MariadbCredentialOutput) Region() pulumi.StringOutput {
	return o.ApplyT(func(v *MariadbCredential) pulumi.StringOutput { return v.Region }).(pulumi.StringOutput)
}
