...
// The resource region. If not defined, the provider region is used.
func (o OpensearchInstanceOutput) Region() pulumi.StringOutput {
	return o.ApplyT(func(v *OpensearchInstance) pulumi.StringOutput { return v.Region }).(pulumi.StringOutput)
}
