...
def get_opensearch_instance(instance_id: Optional[builtins.str] = None,
...
def get_opensearch_instance_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
