...
class GetVolumeResult:
    ...
    def id(self) -> _builtins.str:
        """
        Terraform's internal resource ID. It is structured as "`project_id`,`region`,`volume_id`".
        """
...
def get_volume_output(project_id: pulumi.Input[Optional[_builtins.str]] = None,
