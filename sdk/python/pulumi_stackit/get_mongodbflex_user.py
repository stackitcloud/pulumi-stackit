...
__all__ = [
    'GetMongodbflexUserResult',
    'AwaitableGetMongodbflexUserResult',
    'get_mongodbflex_user',
    'get_mongodbflex_user_output',
]

@pulumi.output_type
class GetMongodbflexUserResult:
    """
...
class AwaitableGetMongodbflexUserResult(GetMongodbflexUserResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMongodbflexUserResult(
...
def get_mongodbflex_user(instance_id: Optional[_builtins.str] = None,
    ...
    return AwaitableGetMongodbflexUserResult(
...
def get_mongodbflex_user_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetMongodbflexUserResult(
