...
__all__ = [
    'GetValkeyInstanceResult',
    'AwaitableGetValkeyInstanceResult',
    'get_valkey_instance',
    'get_valkey_instance_output',
]

@pulumi.output_type
class GetValkeyInstanceResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> 'outputs.GetValkeyInstanceParametersResult':
...
class AwaitableGetValkeyInstanceResult(GetValkeyInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetValkeyInstanceResult(
...
def get_valkey_instance(instance_id: Optional[_builtins.str] = None,
                        project_id: Optional[_builtins.str] = None,
                        region: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetValkeyInstanceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('stackit:index/getValkeyInstance:getValkeyInstance', __args__, opts=opts, typ=GetValkeyInstanceResult).value

    return AwaitableGetValkeyInstanceResult(
...
def get_valkey_instance_output(instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                               project_id: pulumi.Input[Optional[_builtins.str]] = None,
                               region: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetValkeyInstanceResult]:
    """
    Valkey instance data source schema. Must have a `region` specified in the provider configuration.
    ...
    __ret__ = pulumi.runtime.invoke_output('stackit:index/getValkeyInstance:getValkeyInstance', __args__, opts=opts, typ=GetValkeyInstanceResult)
    return __ret__.apply(lambda __response__: GetValkeyInstanceResult(
