...
class SqlserverflexUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the SQLServer Flex instance.
        :param pulumi.Input[builtins.str] project_id: STACKIT project ID to which the instance is associated.
        :param pulumi.Input[builtins.str] username: Username of the SQLServer Flex instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Database access levels for the user. The values for the default roles are: `##STACKIT_DatabaseManager##`, `##STACKIT_LoginManager##`, `##STACKIT_ProcessManager##`, `##STACKIT_ServerManager##`, `##STACKIT_SQLAgentManager##`, `##STACKIT_SQLAgentUser##`
        """
...
class _SqlserverflexUserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the SQLServer Flex instance.
        :param pulumi.Input[builtins.str] password: Password of the user account.
        :param pulumi.Input[builtins.str] project_id: STACKIT project ID to which the instance is associated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Database access levels for the user. The values for the default roles are: `##STACKIT_DatabaseManager##`, `##STACKIT_LoginManager##`, `##STACKIT_ProcessManager##`, `##STACKIT_ServerManager##`, `##STACKIT_SQLAgentManager##`, `##STACKIT_SQLAgentUser##`
...
class SqlserverflexUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlserverflexUser':
        """
