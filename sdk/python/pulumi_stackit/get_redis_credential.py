...
__all__ = [
    'GetRedisCredentialResult',
    'AwaitableGetRedisCredentialResult',
    'get_redis_credential',
    'get_redis_credential_output',
]

@pulumi.output_type
class GetRedisCredentialResult:
    """
    ...
    def load_balanced_host(self) -> builtins.str:
...
class AwaitableGetRedisCredentialResult(GetRedisCredentialResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRedisCredentialResult(
...
def get_redis_credential(credential_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: ID of the Redis instance.
    ...
    return AwaitableGetRedisCredentialResult(
...
def get_redis_credential_output(credential_id: Optional[pulumi.Input[builtins.str]] = None,
