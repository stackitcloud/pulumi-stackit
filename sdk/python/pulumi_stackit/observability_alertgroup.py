...
class ObservabilityAlertgroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Observability instance ID to which the alert group is associated.
        ...
        :param pulumi.Input[builtins.str] name: The name of the alert group. Is the identifier and must be unique in the group.
        """
