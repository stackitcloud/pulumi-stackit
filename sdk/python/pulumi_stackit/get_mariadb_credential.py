...
__all__ = [
    'GetMariadbCredentialResult',
    'AwaitableGetMariadbCredentialResult',
    'get_mariadb_credential',
    'get_mariadb_credential_output',
]

@pulumi.output_type
class GetMariadbCredentialResult:
    """
...
class AwaitableGetMariadbCredentialResult(GetMariadbCredentialResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMariadbCredentialResult(
...
def get_mariadb_credential(credential_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: ID of the MariaDB instance.
    ...
    return AwaitableGetMariadbCredentialResult(
...
def get_mariadb_credential_output(credential_id: Optional[pulumi.Input[builtins.str]] = None,
