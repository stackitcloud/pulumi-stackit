...
__all__ = ['RedisCredentialArgs', 'RedisCredential']
...
class RedisCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the Redis instance.
...
class _RedisCredentialState:
    def __init__(__self__, *,
                 ...
                 load_balanced_host: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the Redis instance.
        :param pulumi.Input[builtins.str] project_id: STACKIT Project ID to which the instance is associated.
        :param pulumi.Input[builtins.str] uri: Connection URI.
        """
    ...
    def load_balanced_host(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "load_balanced_host")

    @load_balanced_host.setter
    def load_balanced_host(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("stackit:index/redisCredential:RedisCredential")
class RedisCredential(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RedisCredentialArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RedisCredentialArgs.__new__(RedisCredentialArgs)
        ...
        super(RedisCredential, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'RedisCredential':
        """
        ...
        __props__ = _RedisCredentialState.__new__(_RedisCredentialState)
    ...
    @property
    @pulumi.getter(name="loadBalancedHost")
    def load_balanced_host(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "load_balanced_host")
