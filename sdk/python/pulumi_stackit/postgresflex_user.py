...
class PostgresflexUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: Database access levels for the user. Possible values are: `login`, `createdb`.
...
class PostgresflexUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uri: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None) -> 'PostgresflexUser':
        """
