...
class GetLogmeCredentialResult:
    ...
    """
    def __init__(__self__, credential_id=None, host=None, id=None, instance_id=None, password=None, port=None, project_id=None, region=None, uri=None, username=None):
