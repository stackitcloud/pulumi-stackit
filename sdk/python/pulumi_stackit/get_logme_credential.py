...
def get_logme_credential(credential_id: Optional[builtins.str] = None,
...
def get_logme_credential_output(credential_id: Optional[pulumi.Input[builtins.str]] = None,
