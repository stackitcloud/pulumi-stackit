...
class GetRoutingTableResult:
    ...
    def id(self) -> _builtins.str:
        """
        Terraform's internal datasource ID. It is structured as "`organization_id`,`region`,`network_area_id`,`routing_table_id`".
        """
...
def get_routing_table_output(network_area_id: pulumi.Input[Optional[_builtins.str]] = None,
