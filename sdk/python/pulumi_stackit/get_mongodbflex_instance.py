...
def get_mongodbflex_instance(instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: ID of the MongoDB Flex instance.
...
def get_mongodbflex_instance_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
