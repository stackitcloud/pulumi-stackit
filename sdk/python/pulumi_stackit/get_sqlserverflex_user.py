...
def get_sqlserverflex_user(instance_id: Optional[builtins.str] = None,
...
def get_sqlserverflex_user_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
