...
class _ServerUpdateScheduleState:
    def __init__(__self__, *,
                 ...
                 maintenance_window: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Maintenance window [1..24]. Updates start within the defined hourly window. Depending on the updates, the process may exceed this timeframe and require an automatic restart.
        """
        return pulumi.get(self, "maintenance_window")
    ...
    @maintenance_window.setter
    def maintenance_window(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "maintenance_window", value)
    ...
    def update_schedule_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Update schedule ID.
        """
    ...
    def update_schedule_id(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class ServerUpdateSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rrule: pulumi.Input[Optional[_builtins.str]] = None,
            server_id: pulumi.Input[Optional[_builtins.str]] = None,
            update_schedule_id: pulumi.Input[Optional[_builtins.int]] = None) -> 'ServerUpdateSchedule':
        """
