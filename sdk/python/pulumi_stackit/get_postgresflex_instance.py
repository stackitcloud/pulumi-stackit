...
def get_postgresflex_instance(instance_id: Optional[builtins.str] = None,
...
def get_postgresflex_instance_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
