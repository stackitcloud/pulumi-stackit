...
def get_server_backup_schedules(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str server_id: Server ID (UUID) to which the backup schedule is associated.
    """
    __args__ = dict()
