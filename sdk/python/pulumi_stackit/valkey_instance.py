...
__all__ = ['ValkeyInstanceArgs', 'ValkeyInstance']

@pulumi.input_type
class ValkeyInstanceArgs:
    def __init__(__self__, *,
                 plan_name: pulumi.Input[_builtins.str],
                 project_id: pulumi.Input[_builtins.str],
                 version: pulumi.Input[_builtins.str],
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional['ValkeyInstanceParametersArgs']] = None,
        ...
        :param pulumi.Input['ValkeyInstanceParametersArgs'] parameters: Configuration parameters. Please note that removing a previously configured field from your Terraform configuration won't replace its value in the API. To update a previously configured field, explicitly set a new value for it.
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Input[Optional['ValkeyInstanceParametersArgs']]:
        """
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[Optional['ValkeyInstanceParametersArgs']]):
...
class _ValkeyInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: ID of the Valkey instance.
        :param pulumi.Input[_builtins.str] name: Instance name.
        :param pulumi.Input['ValkeyInstanceParametersArgs'] parameters: Configuration parameters. Please note that removing a previously configured field from your Terraform configuration won't replace its value in the API. To update a previously configured field, explicitly set a new value for it.
...
@pulumi.type_token("stackit:index/valkeyInstance:ValkeyInstance")
class ValkeyInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional[Union['ValkeyInstanceParametersArgs', 'ValkeyInstanceParametersArgsDict', 'outputs.ValkeyInstanceParameters']]] = None,
                 plan_name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 version: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ValkeyInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ValkeyInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ValkeyInstanceArgs.__new__(ValkeyInstanceArgs)
        ...
        super(ValkeyInstance, __self__).__init__(
            'stackit:index/valkeyInstance:ValkeyInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None) -> 'ValkeyInstance':
        """
        Get an existing ValkeyInstance resource's state with the given name, id, and optional extra
        ...
        __props__ = _ValkeyInstanceState.__new__(_ValkeyInstanceState)
        ...
        __props__.__dict__["region"] = region
        __props__.__dict__["version"] = version
        return ValkeyInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.ValkeyInstanceParameters']:
        """
        Configuration parameters. Please note that removing a previously configured field from your Terraform configuration won't replace its value in the API. To update a previously configured field, explicitly set a new value for it.
        """
        return pulumi.get(self, "parameters")
