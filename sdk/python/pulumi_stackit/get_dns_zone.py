...
class GetDnsZoneResult:
    ...
    def is_reverse_zone(self) -> builtins.bool:
        """
    ...
    def negative_cache(self) -> builtins.int:
        """
        Negative caching.
        """
    ...
    def refresh_time(self) -> builtins.int:
        """
        Refresh time.
        """
    ...
    def retry_time(self) -> builtins.int:
        """
        Retry time.
        """
    ...
    def serial_number(self) -> builtins.int:
        """
        Serial number.
        """
...
def get_dns_zone(dns_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dns_name: The zone name. E.g. `example.com`
    :param builtins.str project_id: STACKIT project ID to which the dns zone is associated.
...
def get_dns_zone_output(dns_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
