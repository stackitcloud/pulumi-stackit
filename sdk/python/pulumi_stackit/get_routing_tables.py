...
class GetRoutingTablesResult:
    ...
    def id(self) -> _builtins.str:
        """
        Terraform's internal datasource ID. It is structured as "`organization_id`,`region`,`network_area_id`".
        """
...
def get_routing_tables_output(network_area_id: pulumi.Input[Optional[_builtins.str]] = None,
