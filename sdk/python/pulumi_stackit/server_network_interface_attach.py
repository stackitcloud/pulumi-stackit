...
class ServerNetworkInterfaceAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: STACKIT project ID to which the network interface attachment is associated.
...
class ServerNetworkInterfaceAttach(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_interface_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerNetworkInterfaceAttach':
        """
