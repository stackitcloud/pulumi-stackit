...
__all__ = [
    'GetRabbitmqInstanceResult',
    'AwaitableGetRabbitmqInstanceResult',
    'get_rabbitmq_instance',
    'get_rabbitmq_instance_output',
]

@pulumi.output_type
class GetRabbitmqInstanceResult:
    """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> 'outputs.GetRabbitmqInstanceParametersResult':
...
class AwaitableGetRabbitmqInstanceResult(GetRabbitmqInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRabbitmqInstanceResult(
...
def get_rabbitmq_instance(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: ID of the RabbitMQ instance.
    ...
    return AwaitableGetRabbitmqInstanceResult(
...
def get_rabbitmq_instance_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
