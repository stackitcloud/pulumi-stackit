...
class GetRedisInstanceResult:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> 'outputs.GetRedisInstanceParametersResult':
...
def get_redis_instance(instance_id: Optional[builtins.str] = None,
...
def get_redis_instance_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
