...
class SqlserverflexInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] acls: The Access Control List (ACL) for the SQLServer Flex instance.
...
class SqlserverflexInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            replicas: Optional[pulumi.Input[builtins.int]] = None,
            storage: Optional[pulumi.Input[Union['SqlserverflexInstanceStorageArgs', 'SqlserverflexInstanceStorageArgsDict']]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlserverflexInstance':
        """
