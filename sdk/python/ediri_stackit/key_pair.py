...
class KeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] public_key: A string representation of the public SSH key. E.g., `ssh-rsa <key_data>` or `ssh-ed25519 <key-data>`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the SSH key pair.
        """
...
class _KeyPairState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fingerprint: The fingerprint of the public SSH key.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels are key-value string pairs which can be attached to a resource container.
        :param pulumi.Input[builtins.str] name: The name of the SSH key pair.
        :param pulumi.Input[builtins.str] public_key: A string representation of the public SSH key. E.g., `ssh-rsa <key_data>` or `ssh-ed25519 <key-data>`.
        """
...
@pulumi.type_token("stackit:index/keyPair:KeyPair")
class KeyPair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            public_key: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyPair':
        """
