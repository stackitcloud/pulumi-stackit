...
export class AuthorizationOrganizationRoleAssignment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorizationOrganizationRoleAssignmentState, opts?: pulumi.CustomResourceOptions): AuthorizationOrganizationRoleAssignment {
        return new AuthorizationOrganizationRoleAssignment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'stackit:index/authorizationOrganizationRoleAssignment:AuthorizationOrganizationRoleAssignment';

    /**
     * Returns true if the given object is an instance of AuthorizationOrganizationRoleAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AuthorizationOrganizationRoleAssignment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AuthorizationOrganizationRoleAssignment.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AuthorizationOrganizationRoleAssignmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AuthorizationOrganizationRoleAssignmentArgs | AuthorizationOrganizationRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
