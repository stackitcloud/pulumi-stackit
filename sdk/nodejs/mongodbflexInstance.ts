...
export class MongodbflexInstance extends pulumi.CustomResource {
    ...
    declare public readonly flavor: pulumi.Output<outputs.MongodbflexInstanceFlavor>;
    /**
    ...
    declare public readonly options: pulumi.Output<outputs.MongodbflexInstanceOptions>;
    /**
    ...
    declare public readonly storage: pulumi.Output<outputs.MongodbflexInstanceStorage>;
