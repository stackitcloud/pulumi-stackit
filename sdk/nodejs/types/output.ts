...
export interface DremioInstanceAuthentication {
     ...
     */
    azuread?: outputs.DremioInstanceAuthenticationAzuread;
    /**
     * OIDC authentication configuration.
     */
    oauth?: outputs.DremioInstanceAuthenticationOauth;
    /**
...
export interface DremioInstanceAuthenticationOauth {
     ...
     */
    jwtClaims: outputs.DremioInstanceAuthenticationOauthJwtClaims;
    /**
     * Any additional parameters the Identity Provider requires.
     */
    parameters?: outputs.DremioInstanceAuthenticationOauthParameter[];
    /**
...
export interface GetDremioInstanceAuthentication {
    /**
     * Azure Active Directory authentication configuration.
     */
    azuread: outputs.GetDremioInstanceAuthenticationAzuread;
    /**
     * OIDC authentication configuration.
     */
    oauth: outputs.GetDremioInstanceAuthenticationOauth;
    /**
     * Type of authentication (local-only, azuread, oauth).
     */
    type: string;
...
export interface GetDremioInstanceAuthenticationAzuread {
    /**
     * The Azure AD authority URL.
     */
    authorityUrl: string;
...
export interface GetDremioInstanceAuthenticationOauth {
    /**
     * The Issuer location URI, where the OIDC provider configuration can be found.
     */
    authorityUrl: string;
     ...
     * Maps fields from the JWT token to fields Dremio requires.
     */
    jwtClaims: outputs.GetDremioInstanceAuthenticationOauthJwtClaims;
    /**
     * Any additional parameters the Identity Provider requires.
     */
    parameters: outputs.GetDremioInstanceAuthenticationOauthParameter[];
    /**
     * The URL where the Dremio instance is hosted. The URL must match the redirect URL set in the Identity Provider.
     */
    redirectUrl: string;
...
export interface GetDremioInstanceAuthenticationOauthJwtClaims {
    /**
     * Mapped user name claim (e.g. email).
     */
    userName: string;
...
export interface GetDremioInstanceAuthenticationOauthParameter {
    /**
     * Parameter name.
     */
    name: string;
...
export interface GetDremioInstanceEndpoints {
    /**
     * The arrow flight endpoint of the Dremio instance.
     */
    arrowFlight: string;
...
export interface GetTelemetryrouterDestinationConfig {
    /**
     ...
     */
    filter: outputs.GetTelemetryrouterDestinationConfigFilter;
    /**
     * OpenTelemetry configuration
     */
    opentelemetry: outputs.GetTelemetryrouterDestinationConfigOpentelemetry;
    /**
     * S3 configuration
     */
    s3: outputs.GetTelemetryrouterDestinationConfigS3;
}

export interface GetTelemetryrouterDestinationConfigFilter {
    /**
     * The TelemetryRouter destination's filter attributes
     */
    attributes: outputs.GetTelemetryrouterDestinationConfigFilterAttribute[];
}

export interface GetTelemetryrouterDestinationConfigFilterAttribute {
    /**
...
export interface GetTelemetryrouterDestinationConfigOpentelemetry {
    /**
...
export interface GetTelemetryrouterDestinationConfigS3 {
    /**
     * S3 bucket name
     */
    bucket: string;
...
export interface GetTelemetryrouterInstanceFilter {
    /**
     * The TelemetryRouter global filter attributes
     */
    attributes: outputs.GetTelemetryrouterInstanceFilterAttribute[];
}

export interface GetTelemetryrouterInstanceFilterAttribute {
    /**
...
export interface GetVpcRoutingTableStaticRouteDestination {
    type: string;
    value: string;
}

export interface GetVpcRoutingTableStaticRouteNexthop {
    type: string;
    value: string;
}
...
export interface GetVpnGatewayBgp {
    /**
...
export interface TelemetryrouterDestinationConfig {
     ...
     * The TelemetryRouter destination's filter settings
     */
    filter?: outputs.TelemetryrouterDestinationConfigFilter;
    /**
     * OpenTelemetry configuration
     */
    opentelemetry?: outputs.TelemetryrouterDestinationConfigOpentelemetry;
    /**
     * S3 configuration
     */
    s3?: outputs.TelemetryrouterDestinationConfigS3;
}
...
export interface TelemetryrouterDestinationConfigFilter {
     ...
     * The TelemetryRouter destination's filter attributes
     */
    attributes: outputs.TelemetryrouterDestinationConfigFilterAttribute[];
}
...
export interface TelemetryrouterDestinationConfigOpentelemetry {
     ...
     */
    basicAuth?: outputs.TelemetryrouterDestinationConfigOpentelemetryBasicAuth;
    /**
...
export interface TelemetryrouterDestinationConfigS3 {
     ...
     */
    accessKey?: outputs.TelemetryrouterDestinationConfigS3AccessKey;
    /**
     * S3 bucket name
     */
    bucket: string;
...
export interface TelemetryrouterInstanceFilter {
     ...
     * The TelemetryRouter global filter attributes
     */
    attributes: outputs.TelemetryrouterInstanceFilterAttribute[];
}
