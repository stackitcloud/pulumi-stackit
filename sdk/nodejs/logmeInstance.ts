...
export class LogmeInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogmeInstanceState, opts?: pulumi.CustomResourceOptions): LogmeInstance {
        return new LogmeInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'stackit:index/logmeInstance:LogmeInstance';

    /**
     * Returns true if the given object is an instance of LogmeInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogmeInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LogmeInstance.__pulumiType;
    }
    ...
    declare public readonly parameters: pulumi.Output<outputs.LogmeInstanceParameters>;
    /**
     ...
     */
    constructor(name: string, args: LogmeInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LogmeInstanceArgs | LogmeInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogmeInstanceState | undefined;
            ...
            const args = argsOrState as LogmeInstanceArgs | undefined;
        ...
        super(LogmeInstance.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LogmeInstanceArgs {
    /**
     * Instance name.
     */
    name?: pulumi.Input<string>;
