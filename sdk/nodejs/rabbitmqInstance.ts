...
export class RabbitmqInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'stackit:index/rabbitmqInstance:RabbitmqInstance';
     ...
     */
    declare public readonly parameters: pulumi.Output<outputs.RabbitmqInstanceParameters>;
    /**
...
export interface RabbitmqInstanceState {
     ...
     * Configuration parameters. Please note that removing a previously configured field from your Terraform configuration won't replace its value in the API. To update a previously configured field, explicitly set a new value for it.
     */
    parameters?: pulumi.Input<inputs.RabbitmqInstanceParameters | undefined>;
    /**
     * The selected plan ID.
     */
