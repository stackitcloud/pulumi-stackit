 ...
 * ## Example Usage
 */
export function getSecretsmanagerSecretGroupRoleBindingsV1(args: GetSecretsmanagerSecretGroupRoleBindingsV1Args, opts?: pulumi.InvokeOptions): Promise<GetSecretsmanagerSecretGroupRoleBindingsV1Result> {
 ...
 * ## Example Usage
 */
export function getSecretsmanagerSecretGroupRoleBindingsV1Output(args: GetSecretsmanagerSecretGroupRoleBindingsV1OutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecretsmanagerSecretGroupRoleBindingsV1Result> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
