...
export class AuthorizationFolderCustomRole extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorizationFolderCustomRoleState, opts?: pulumi.CustomResourceOptions): AuthorizationFolderCustomRole {
        return new AuthorizationFolderCustomRole(name, <any>state, { ...opts, id: id });
    }
