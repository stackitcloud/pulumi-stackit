 ...
 */
export class ValkeyInstance extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ValkeyInstanceState, opts?: pulumi.CustomResourceOptions): ValkeyInstance {
        return new ValkeyInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'stackit:index/valkeyInstance:ValkeyInstance';

    /**
     * Returns true if the given object is an instance of ValkeyInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ValkeyInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ValkeyInstance.__pulumiType;
    }
     ...
     */
    declare public readonly parameters: pulumi.Output<outputs.ValkeyInstanceParameters>;
    /**
     ...
     */
    constructor(name: string, args: ValkeyInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ValkeyInstanceArgs | ValkeyInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ValkeyInstanceState | undefined;
            ...
            const args = argsOrState as ValkeyInstanceArgs | undefined;
        ...
        super(ValkeyInstance.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ValkeyInstanceState {
     ...
     * Configuration parameters. Please note that removing a previously configured field from your Terraform configuration won't replace its value in the API. To update a previously configured field, explicitly set a new value for it.
     */
    parameters?: pulumi.Input<inputs.ValkeyInstanceParameters | undefined>;
    /**
     * The selected plan ID.
     */
 ...
 */
export interface ValkeyInstanceArgs {
    /**
     * Instance name.
     */
    name?: pulumi.Input<string | undefined>;
