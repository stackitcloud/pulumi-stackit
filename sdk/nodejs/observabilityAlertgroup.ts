...
export class ObservabilityAlertgroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObservabilityAlertgroupState, opts?: pulumi.CustomResourceOptions): ObservabilityAlertgroup {
        return new ObservabilityAlertgroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'stackit:index/observabilityAlertgroup:ObservabilityAlertgroup';

    /**
     * Returns true if the given object is an instance of ObservabilityAlertgroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObservabilityAlertgroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObservabilityAlertgroup.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ObservabilityAlertgroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObservabilityAlertgroupArgs | ObservabilityAlertgroupState, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface ObservabilityAlertgroupState {
    /**
     * Observability instance ID to which the alert group is associated.
     */
 ...
 */
export interface ObservabilityAlertgroupArgs {
    /**
     * Observability instance ID to which the alert group is associated.
     */
    instanceId: pulumi.Input<string>;
