...
namespace Pulumi.Stackit
{
    ...
    public partial class SecretsmanagerInstanceRoleBindingV1 : global::Pulumi.CustomResource
    {
        ...
        private SecretsmanagerInstanceRoleBindingV1(string name, Input<string> id, SecretsmanagerInstanceRoleBindingV1State? state = null, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretsmanagerInstanceRoleBindingV1 Get(string name, Input<string> id, SecretsmanagerInstanceRoleBindingV1State? state = null, CustomResourceOptions? options = null)
        {
