...
namespace Pulumi.Stackit
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/stackitcloud/pulumi-stackit";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Stackit.version.txt");
    ...
    internal sealed class StackitResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public StackitResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
