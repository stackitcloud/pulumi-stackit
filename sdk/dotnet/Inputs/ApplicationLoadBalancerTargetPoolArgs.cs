...
namespace Pulumi.Stackit.Inputs
{
    ...
    public sealed class ApplicationLoadBalancerTargetPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationLoadBalancerTargetPoolActiveHealthCheckArgs>? ActiveHealthCheck { get; set; }
        ...
        private InputList<Inputs.ApplicationLoadBalancerTargetPoolTargetArgs>? _targets;

        /// <summary>
        /// List of all targets which will be used in the pool. Limited to 250.
        /// </summary>
        public InputList<Inputs.ApplicationLoadBalancerTargetPoolTargetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.ApplicationLoadBalancerTargetPoolTargetArgs>());
            set => _targets = value;
        }
        ...
        /// </summary>
        [Input("tlsConfig")]
        public Input<Inputs.ApplicationLoadBalancerTargetPoolTlsConfigArgs>? TlsConfig { get; set; }
