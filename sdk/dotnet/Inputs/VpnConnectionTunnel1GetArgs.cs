...
namespace Pulumi.Stackit.Inputs
{
    ...
    {
        [Input("bgp")]
        public Input<Inputs.VpnConnectionTunnel1BgpGetArgs>? Bgp { get; set; }

        [Input("peering")]
        public Input<Inputs.VpnConnectionTunnel1PeeringGetArgs>? Peering { get; set; }

        [Input("phase1", required: true)]
        public Input<Inputs.VpnConnectionTunnel1Phase1GetArgs> Phase1 { get; set; } = null!;

        [Input("phase2", required: true)]
        public Input<Inputs.VpnConnectionTunnel1Phase2GetArgs> Phase2 { get; set; } = null!;
