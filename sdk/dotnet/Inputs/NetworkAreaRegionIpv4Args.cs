...
namespace Pulumi.Stackit.Inputs
{
    ...
    public sealed class NetworkAreaRegionIpv4Args : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.NetworkAreaRegionIpv4NetworkRangeArgs>? _networkRanges;

        /// <summary>
        /// List of Network ranges.
        /// </summary>
        public InputList<Inputs.NetworkAreaRegionIpv4NetworkRangeArgs> NetworkRanges
        {
            get => _networkRanges ?? (_networkRanges = new InputList<Inputs.NetworkAreaRegionIpv4NetworkRangeArgs>());
