...
namespace Pulumi.Stackit.Inputs
{
    ...
    public sealed class CdnDistributionConfigRedirectsRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CdnDistributionConfigRedirectsRuleMatcherGetArgs>? _matchers;

        /// <summary>
        /// A list of matchers that define when this rule should apply. At least one matcher is required
        /// </summary>
        public InputList<Inputs.CdnDistributionConfigRedirectsRuleMatcherGetArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.CdnDistributionConfigRedirectsRuleMatcherGetArgs>());
            set => _matchers = value;
        }
