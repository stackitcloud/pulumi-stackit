...
namespace Pulumi.Stackit.Inputs
{
    ...
    {
        [Input("bgp")]
        public Input<Inputs.VpnConnectionTunnel2BgpGetArgs>? Bgp { get; set; }

        [Input("peering")]
        public Input<Inputs.VpnConnectionTunnel2PeeringGetArgs>? Peering { get; set; }

        [Input("phase1", required: true)]
        public Input<Inputs.VpnConnectionTunnel2Phase1GetArgs> Phase1 { get; set; } = null!;

        [Input("phase2", required: true)]
        public Input<Inputs.VpnConnectionTunnel2Phase2GetArgs> Phase2 { get; set; } = null!;
