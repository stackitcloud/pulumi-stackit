...
namespace Pulumi.Stackit.Inputs
{
    ...
    public sealed class ApplicationLoadBalancerListenerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationLoadBalancerListenerHttpArgs> Http { get; set; } = null!;

        /// <summary>
        /// Configuration for handling HTTPS traffic on this listener.
        /// </summary>
        [Input("https")]
        public Input<Inputs.ApplicationLoadBalancerListenerHttpsArgs>? Https { get; set; }
