...
namespace ediri.Stackit.Inputs
{
    ...
    public sealed class LoadbalancerOptionsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("acls")]
        ...
        /// </summary>
        [Input("observability")]
        public Input<Inputs.LoadbalancerOptionsObservabilityGetArgs>? Observability { get; set; }
        ...
        public LoadbalancerOptionsGetArgs()
        {
        }
        public static new LoadbalancerOptionsGetArgs Empty => new LoadbalancerOptionsGetArgs();
    }
}
