...
namespace Pulumi.Stackit.Inputs
{
    ...
    public sealed class ObservabilityInstanceAlertConfigRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("routes")]
        private InputList<Inputs.ObservabilityInstanceAlertConfigRouteRouteArgs>? _routes;

        /// <summary>
        /// List of child routes.
        /// </summary>
        public InputList<Inputs.ObservabilityInstanceAlertConfigRouteRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.ObservabilityInstanceAlertConfigRouteRouteArgs>());
            set => _routes = value;
        }

        public ObservabilityInstanceAlertConfigRouteArgs()
        {
        }
        public static new ObservabilityInstanceAlertConfigRouteArgs Empty => new ObservabilityInstanceAlertConfigRouteArgs();
    }
}
