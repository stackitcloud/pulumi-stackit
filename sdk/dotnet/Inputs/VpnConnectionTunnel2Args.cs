...
namespace Pulumi.Stackit.Inputs
{
    ...
    {
        [Input("bgp")]
        public Input<Inputs.VpnConnectionTunnel2BgpArgs>? Bgp { get; set; }

        [Input("peering")]
        public Input<Inputs.VpnConnectionTunnel2PeeringArgs>? Peering { get; set; }

        [Input("phase1", required: true)]
        public Input<Inputs.VpnConnectionTunnel2Phase1Args> Phase1 { get; set; } = null!;

        [Input("phase2", required: true)]
        public Input<Inputs.VpnConnectionTunnel2Phase2Args> Phase2 { get; set; } = null!;
